...
# [](#header-1)Higher-Order Functions in React
...
We will start by creating a simple component with a + button to increment a counter.
...
# [](#header-1) Using indexes as a key
...
# [](#header-1)Handler Function in JSX
